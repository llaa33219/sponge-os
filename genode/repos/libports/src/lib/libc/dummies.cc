...
DUMMY(unsigned int, 0, if_nametoindex, (const char *))
...
DUMMY(void  ,   , pthread_get_name_np, (pthread_t, char *, size_t))
DUMMY(int   , -1, pthread_getaffinity_np, (pthread_t, size_t, cpuset_t *))
DUMMY(int   , -1, pthread_getschedparam, (pthread_t pthread, int * __restrict, struct sched_param * __restrict))
DUMMY(void  ,   , pthread_set_name_np, (pthread_t, const char *))
DUMMY(int   , -1, pthread_setaffinity_np, (pthread_t, size_t, const cpuset_t *))
DUMMY(int   , -1, pthread_setschedparam, (pthread_t, int, const struct sched_param *))
DUMMY(int   , -1, rmdir, (const char *))
DUMMY(void *,  0, sbrk, (intptr_t))
DUMMY(int   , -1, sched_get_priority_max, (int))
DUMMY(int   , -1, sched_get_priority_min, (int))
...
DUMMY(int   , -1, sendfile, (int, int, off_t, size_t, struct sf_hdtr *, off_t *, int))
...
DUMMY(void  ,   , setproctitle, (const char *_fmt, ...))
...
DUMMY(int, -1, lchown, (const char *, uid_t, gid_t))
DUMMY(int, -1, lockf, (int, int, off_t))
DUMMY_SILENT(int,  0, posix_fadvise, (int, off_t, off_t, int))
DUMMY(int, -1, chmod, (const char *, mode_t))
DUMMY_SILENT(int, -1, chown, (const char *, uid_t, gid_t))
DUMMY_SILENT(int, -1, fchown, (int, uid_t, gid_t))
