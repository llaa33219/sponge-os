...
INC_DIR += $(VIRTUALBOX_DIR)/src/libs/liblzf-$(LIBLZF_VERSION)
...
SRC_CC += Runtime/common/efi/efiguid.cpp
SRC_CC += Runtime/common/efi/efisignaturedb.cpp
SRC_CC += Runtime/common/efi/efitime.cpp
SRC_CC += Runtime/common/efi/efivarstorevfs.cpp
...
SRC_CC += Runtime/common/vfs/vfsmemory.cpp
...
SRC_CC += Runtime/common/zip/cpiovfs.cpp
SRC_CC += Runtime/common/zip/tarvfs.cpp
SRC_CC += Runtime/common/zip/tarvfswriter.cpp
