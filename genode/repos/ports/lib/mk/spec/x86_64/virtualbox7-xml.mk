...
ZLIB_DIR   = $(VIRTUALBOX_DIR)/src/libs/zlib-$(ZLIB_VERSION)
LIBXML_DIR = $(VIRTUALBOX_DIR)/src/libs/libxml2-$(LIBXML2_VERSION)
...
SRC_C  += SAX2.c xmlIO.c xmlmemory.c xmlreader.c xmlregexp.c xmlschemas.c
SRC_C  += xmlschemastypes.c xmlsave.c xmlstring.c xpath.c xpointer.c
SRC_C  += xinclude.c
